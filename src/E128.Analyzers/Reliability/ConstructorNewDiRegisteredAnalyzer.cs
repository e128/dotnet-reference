...
public sealed class ConstructorNewDiRegisteredAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly DiagnosticDescriptor Rule = new(
        id: DiagnosticId,
        title: "Constructor news a DI-registered type — inject via DI instead",
        messageFormat: "'{0}' is registered in DI — inject it via the constructor parameter list instead of using 'new'",
        category: "Reliability",
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
        description: "When a type is registered in the DI container via AddSingleton<T>, AddScoped<T>, " +
