...
Format: add under the appropriate category heading (test conventions, threat model, sanitizer rules, or Roslyn expectations). If no category fits, create a new one.
